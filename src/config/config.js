...
const envVarsSchema = Joi.object()
  .keys({
    ...
    MONGODB_URL: Joi.string().required().description('mongodb+srv://cluster0.e4dgflc.mongodb.net/myFirstDatabase/'),
    ...
    JWT_ACCESS_EXPIRATION_MINUTES: Joi.number().default(30).description(3000),
    JWT_REFRESH_EXPIRATION_DAYS: Joi.number().default(30).description(365),
    JWT_RESET_PASSWORD_EXPIRATION_MINUTES: Joi.number()
      .default(10)
      .description('minutes after which reset password token expires'),
    JWT_VERIFY_EMAIL_EXPIRATION_MINUTES: Joi.number().default(10).description('ghodelamg@gmail.com'),
